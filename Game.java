...
public class Game extends JPanel implements Runnable, MouseListener {
    ...
    float gravity = 0.25f;
    boolean inGame;
    boolean isGameOver; // New flag to indicate game over
    ...
    public void draw() {
        ...
        g2.drawImage(background, backgroundBox.x, backgroundBox.y, (int) backgroundBox.getWidth(), (int) backgroundBox.getHeight(), null);
        g2.drawImage(background, (int) (backgroundBox.x + backgroundBox.getWidth()), backgroundBox.y, (int) backgroundBox.getWidth(), (int) backgroundBox.getHeight(), null);
        ...
        g2.drawImage(floor, floorBox.x, floorBox.y, (int) floorBox.getWidth(), (int) floorBox.getHeight(), null);
        g2.drawImage(floor, (int) (floorBox.x + floorBox.getWidth()), floorBox.y, (int) floorBox.getWidth(), (int) floorBox.getHeight(), null);

        g2.drawImage(bird, flappyBox.x, flappyBox.y, (int) flappyBox.getWidth(), (int) flappyBox.getHeight(), null);

        if (!inGame && !isGameOver) {
            g2.drawImage(tapToStartTheGame, tapToStartTheGameBox.x, tapToStartTheGameBox.y, (int) tapToStartTheGameBox.getWidth(), (int) tapToStartTheGameBox.getHeight(), null);
        }

        if (isGameOver) {
            g2.setColor(Color.RED);
            g2.setFont(new Font("TimesRoman", Font.BOLD, 30 * DISTORTION));
            g2.drawString("Game Over!", SIZE / 4, SIZE / 2);

            g2.setFont(new Font("TimesRoman", Font.BOLD, 20 * DISTORTION));
            g2.setColor(Color.WHITE);
            g2.drawString("Your Score: " + point, SIZE / 4, (SIZE / 2) + 40 * DISTORTION);
            g2.drawString("High Score: " + record, SIZE / 4, (SIZE / 2) + 70 * DISTORTION);
        }
        ...
        if (!inGame && !isGameOver) {
            ...
            g2.drawString("Score: " + point, 10, 35);
            g2.drawString("High Score: " + record, 10, 60);
        }
